...
class TTrainingDetails extends StatefulWidget {
  @override
  TTrainingDetailsstate createState() => TTrainingDetailsstate();
}

class TTrainingDetailsstate extends State<TTrainingDetails> {
